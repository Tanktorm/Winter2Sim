...
class UserStrategy:
    ...
    def select_vessel_for_berth(
        ...
        """
        return chrono_strategy.select_vessel_for_berth(
            maritime_data_context,
            port,
            waiting_vessels,
            available_berths,
    ...
    def assign_associated_bookings(context, now, shipment):
        ...
        """
        return chrono_strategy.assign_bookings(context, now, shipment)
    ...
    def adjust_bookings_before_cargo_handling(context, now, vessel):
        ...
        """
        return chrono_strategy.adjust_bookings_before_cargo_handling(
            context, now, vessel
        )
